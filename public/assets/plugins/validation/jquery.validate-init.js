jQuery(".form-valide").validate({
    ...
    rules: {
        "val-name": { required: !0, minlength: 3 },
        "val-username": { required: !0, minlength: 3 },
        "val-email": { required: !0, email: !0 },
        "val-password": { required: !0, minlength: 5 },
        "val-contact": { required: !0, minlength: 10 },
        "val-companyname": { required: !0, minlength: 5 },
    ...
    messages: {
        "val-name": { required: "Please enter a name", minlength: "Your name must consist of at least 2 characters" },
        ...
        "val-contact": { required: "Please enter a Number", minlength: "Your Number must consist of at least 10 Digits" },

        "val-companyname": { required: "Please enter a Companyname", minlength: "Your Companyname must consist of at least 5 characters" },
        ...
        "val-skill": "Please select a user!",
