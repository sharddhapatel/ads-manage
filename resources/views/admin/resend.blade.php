                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                @endif
                                <form class="mt-5 mb-5 login-input" action="{{url('resendpassword')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}

                                <input type="hidden" name="id"  id="id" value="{{$list->id}}">
                                <input type="hidden" name="token"  id="token" value="{{ $list->remember_token }}">
