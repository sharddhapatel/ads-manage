                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4 style="margin-bottom: 0px;">XYZ</h4>
                            </div>
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="" style="text-decoration: none;">
                                                                <h6 class="badge-info1" style="width:350px;">Live Cricket TV - HD Cricket</h6>
                                                            </a>
                                                            <div class="text-success text-small font-600-bold"><i class="fas fa-circle"></i> com.livecricketscore.cricketfastliveline.cricketliveline.fastestlivelinetvv</div>
                                                            <div class="text-small font-weight-500 text-muted">Watch Live Cricket Match Today Live</div>
                                                            <div class="text-small font-weight-500 ">Banner, NativeBanner, Native, Interstitial, AppOpen</div>
