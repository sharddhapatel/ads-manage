                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{url('appwisecustomadsequence')}}"><button type="button" class="btn btn-success">Ad sequence</button></a>
                                </div>
                            </div>
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-success px-2">Enable</span>
                                                            <td>
                                                                <a class="btn btn-info" href="#"><i class="fas fa-plus"></i>Select</a></span>
                                                            </td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
